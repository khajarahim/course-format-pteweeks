...
/**
 * Event observer for format_pteweeks.
 *
 * @package format_pteweeks
 * @copyright 2017 Mark Nelson <markn@moodle.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_pteweeks_observer {
    ...
    public static function course_updated(\core\event\course_updated $event) {
        if (class_exists('format_pteweeks', false)) {
            // If class format_pteweeks was never loaded, this is definitely not a course in 'weeks' format.
            // Course may still be in another format but format_pteweeks::update_end_date() will check it.
            format_pteweeks::update_end_date($event->courseid);
        }
    }
