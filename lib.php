 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_pteweeks extends format_base {
    ...
    public function get_default_section_name($section) {
        if ($section->section == 0) {
            ...
            return get_string('section0name', 'format_pteweeks');
        } else {
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            $courseformatoptionsedit = array(
                ...
                'automaticenddate' => array(
                    'label' => new lang_string('automaticenddate', 'format_pteweeks'),
                    'help' => 'automaticenddate',
                    'help_component' => 'format_pteweeks',
    ...
    public function inplace_editable_render_section_name($section, $linkifneeded = true,
        ...
        if (empty($edithint)) {
            $edithint = new lang_string('editsectionname', 'format_pteweeks');
        }
        if (empty($editlabel)) {
            $title = get_section_name($section->course, $section);
            $editlabel = new lang_string('newsectionname', 'format_pteweeks', $title);
        }
    ...
    public function section_action($section, $action, $sr) {
        ...
        $renderer = $PAGE->get_renderer('format_pteweeks');
 ...
 * @return \core\output\inplace_editable
 */
function format_pteweeks_inplace_editable($itemtype, $itemid, $newvalue) {
    global $DB, $CFG;
