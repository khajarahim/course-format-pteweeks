...
/**
 * format_pteweeks related unit tests
 *
 * @package    format_pteweeks
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_pteweeks_testcase extends advanced_testcase {

    /**
     * Tests for format_pteweeks::get_section_name method with default section names.
     */
    ...
    /**
     * Tests for format_pteweeks::get_section_name method with modified section names.
     */
    ...
    /**
     * Tests for format_pteweeks::get_default_section_name.
     */
    public function test_get_default_section_name() {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_pteweeks');
    ...
    public function test_update_inplace_editable() {
        ...
        try {
            core_external::update_inplace_editable('format_pteweeks', 'sectionname', $section->id, 'New section name');
        ...
        $res = core_external::update_inplace_editable('format_pteweeks', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable() {
        ...
        // Call callback format_pteweeks_inplace_editable() directly.
        $tmpl = component_callback('format_pteweeks', 'inplace_editable', array('sectionname', $section->id, 'Rename me again'));
    ...
    public function test_default_course_enddate() {
        ...
        // format_pteweeks::get_section_dates is adding 2h to avoid DST problems, we need to replicate it here.
