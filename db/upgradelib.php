 ...
 * For each such course we call {@link format_pteweeks_upgrade_hide_extra_sections()} and
 * either delete or hide "orphaned" sections.
 */
function format_pteweeks_upgrade_remove_numsections() {
    global $DB;
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_pteweeks_upgrade_hide_extra_sections($courseid, $numsections);
    }
 ...
 */
function format_pteweeks_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
