...
/**
 * Upgrade script for format_pteweeks
 *
 * @param int $oldversion the version we are upgrading from
 * @return bool result
 */
function xmldb_format_pteweeks_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2017020200) {
        ...
        format_pteweeks_upgrade_remove_numsections();
    ...
    if ($oldversion < 2017050300) {
        ...
        foreach ($courses as $course) {
            ...
            if (empty($course->enddate)) {
                ...
                format_pteweeks::update_end_date($course->id);
            } else {
                $option->value = 0;
                $DB->insert_record('course_format_options', $option);
            }
